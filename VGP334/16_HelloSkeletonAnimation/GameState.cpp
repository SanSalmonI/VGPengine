...
void GameState::Initialize()
{
	...
	ModelManager::Get()->AddAnimation(mCharacter.modelId,L"../../Assets/Models/Character01/Animations/Idle.anim");
...
void GameState::DebugUI()
{
	...
	ImGui::DragFloat("AnimSpeed", &mAnimationSpeed, 1.0f, 0.0f, 10.0f);
